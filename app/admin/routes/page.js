...
// Справочник наших реальных шагов СЭД
const STEPS = {
    1: "1. Начальник подразделения (Бюджет)",
    2: "2. Директор (Одобрение/Срочность)",
    3: "3. Склад (Проверка наличия ТМЦ)",
    4: "4. Ком. Директор (Контрагент и условия)",
    5: "5. Экономист (Подтверждение/Примечания)",
    6: "6. Фин. Директор (Утверждение)",
    7: "7. Юрист (Загрузка проекта договора)",
    8: "8. Финансист (Проверка проекта договора)",
    9: "9. Юрист (Загрузка подписанного скана)",
    10: "10. Бухгалтерия (Запрос на оплату)",
    11: "11. Финансист (Одобрение оплаты)",
    12: "12. Бухгалтерия (Проведение платежа)",
    100: "✅ ФИНИШ (Оплачено / Выдано со склада)",
    "-1": "❌ ОТКАЗ / ВОЗВРАТ НА ДОРАБОТКУ"
};
